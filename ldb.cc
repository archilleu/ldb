...
//---------------------------------------------------------------------------
ObjectPtr Ldb::kNullObject;
//---------------------------------------------------------------------------
bool Ldb::UnarySetBoolean(const String& key, bool val)
{
    ObjectPtr obj_val = std::make_shared<Object>(TYPE_BOOLEAN);
    obj_val->obj_ = std::make_shared<bool>(val);
...
{
    ObjectPtr obj_val = std::make_shared<Object>(TYPE_INT);
    obj_val->obj_ = std::make_shared<int64_t>(val);
...
{
    ObjectPtr obj_val = std::make_shared<Object>(TYPE_UINT);
    obj_val->obj_ = std::make_shared<uint64_t>(val);
...
{
    ObjectPtr obj_val = std::make_shared<Object>(TYPE_FLOAT);
    obj_val->obj_ = std::make_shared<double>(val);
...
{
    ObjectPtr obj_val = std::make_shared<Object>(TYPE_BINARY);
    obj_val->obj_ = std::make_shared<Binary>(val);
...
{
    ObjectPtr obj_val = std::make_shared<Object>(TYPE_STRING);
    obj_val->obj_ = std::make_shared<String>(val);
...
bool Ldb::UnaryGetBoolean(const String& key, bool* val)
{
    ...
    {
        *val = *reinterpret_cast<bool*>(iter->second->obj_.get());
        return true;
    }
    else
    {
...
bool Ldb::UnaryGetInt(const String& key, int64_t* val)
{
    ...
    {
        *val = *reinterpret_cast<int64_t*>(iter->second->obj_.get());
        return true;
    }
    else
    {
...
bool Ldb::UnaryGetUInt(const String& key, uint64_t* val)
{
    ...
    {
        *val = *reinterpret_cast<uint64_t*>(iter->second->obj_.get());
        return true;
    }
    else
    {
...
bool Ldb::UnaryGetFloat(const String& key, double* val)
{
    ...
    {
        *val = *reinterpret_cast<double*>(iter->second->obj_.get());
        return true;
    }
    else
    {
...
bool Ldb::UnaryGetBinary(const String& key, Binary* val)
{
    ...
    {
        *val = *reinterpret_cast<Binary*>(iter->second->obj_.get());
        return true;
    }
    else
    {
...
bool Ldb::UnaryGetString(const String& key, String* val)
{
    ...
    {
        *val = *reinterpret_cast<String*>(iter->second->obj_.get());
        return true;
    }
    else
    {
