//---------------------------------------------------------------------------
#ifndef BASE_LINUX_BASE_LOG_FILE_H_
#define BASE_LINUX_BASE_LOG_FILE_H_ 
//---------------------------------------------------------------------------
#include "share_inc.h"
#include "thread.h"
...
public:
    ...
    bool Initialze  (const std::string& title, const std::string& path, const std::string& name, size_t max_size);
    void Uninitialze();
...
//---------------------------------------------------------------------------
#endif // BASE_LINUX_BASE_LOG_FILE_H_
